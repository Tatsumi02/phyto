...
<div class="container" style="background:white; padding:2%; text-align:left;">
    <h2>
    <a href="?action=notif_inter2" class="btn btn-primary">Notifications pour les importations</a>
    <br><br>    
    Fiche de suivi des notifications d'interceptions pour les exportations</h2>
...
<?php 
           ...
           ?>
    <form action="?action=save_certificat" method="post">
        ...
        <br>
        <input required type="text" name="quantite_date" class="form-control" placeholder="Quantite expediee et date d'expedition">
        <br>
        <label for="e">Exportateur</label>
