...
<br><br>
    <div>
        <a href="?action=presentation_export_gargaison" class="btn btn-primary col-md-12">Presentation des exportations en cargaisons</a>
        <br>
        <a href="?action=presentation_export_soute" class="btn btn-primary col-md-12">Presentation des exportations en soutes</a>
        <br><br><br>
        <a href="?action=presentation_import_gargaison" class="btn btn-primary col-md-12">Presentation des importations en cargaisons</a>
        <br>
        <a href="?action=presentation_import_soute" class="btn btn-primary col-md-12">Presentation des importations en soutes</a>
        <br>
        <br>
        <br><br>
        ...
        <br><br><br><br>
        <a href="?action=evolution_import" class="btn btn-warning col-md-12">evolution globale mensuelle des principal importations tout au long de l'annee </a>
