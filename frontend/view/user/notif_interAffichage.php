...
<div class="container" style="background:white; padding:2%; text-align:left;">
    <h2> Fiche de suivi des notifications d'interceptions des importations </h2>
           ...
           <?php 
            ...
            ?>
                 <tr>
                    ...
                    <td><?= $datas['quantite_produit'] ?></td>
                    <td><?= $datas['quantite_date_expedition'] ?></td>
                    <td><?= $datas['exportateur'] ?></td>
                    <td><?= $datas['mesure_prescite'] ?></td>
