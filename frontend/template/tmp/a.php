				 ...
				 <!--top-nav-->
					<div class="col-md-8 top-nav">
					  <span class="menu"> <img src="fontend/public/img/logo.jpg" alt=""></span>
						<ul class="res">
							<li><a href="?action=admin_panel" class="<?= $active1 ?>"><i class="glyphicon glyphicon-home"> </i> Accueil</a></li>
							<li><a class="<?= $active2 ?>" href="?action=speculation"><i class="glyphicon glyphicon-user"> </i>Speculation</a></li>
							<li><a class="<?= $active3 ?>" href="?action=acteur"><i class="glyphicon glyphicon-user"> </i>Acteur</a></li>
							<li><a class="<?= $active4 ?>" href="?action=produit"><i class="glyphicon glyphicon-user"> </i>Produits</a></li>
