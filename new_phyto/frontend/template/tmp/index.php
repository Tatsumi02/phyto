...
<style>
	...
	body{
		/* background:url('frontend/public/img/future-tech.jpg'); */
				 ...
				 <!--top-nav-->
					<div class="col-md-8 top-nav">
					  <span class="menu"> <img src="fontend/public/img/logo.jpg" alt=""></span>
						<ul class="res">
							<li><a href="?" class="<?= $active1 ?>"><i class="glyphicon glyphicon-home"> </i> Accueil</a></li>
							<li><a class="<?= $active2 ?>" href="?action=intro"><i class="glyphicon glyphicon-user"> </i> Inscription</a></li>
							<li><a href="https://www.allotraining.com" class="<?= $active3 ?>">Allo! Training <div class="rate">5</div></a></li>
						</ul>
			<!-- script-for-menu -->
						 <script>
