...
<h2>Effectuer une importation instantanée</h2>
    <br>
    <?php 
    ...
    <br>
    <p>
        <form action="?action=save_importation" method="post"  style="text-align:left;">
           ...
           <select name="exportateur_id" class="form-control" id="acteur">
            ...
            <label for="produit">Speculation</label>
            <select name="produits" id="produit" class="form-control">
                    <option value="indef">--------</option>
                   <?php 
                        while($prod = $speculations -> fetch()){
                    ?>
